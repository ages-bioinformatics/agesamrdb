...
python amrdb_add_results.py --method plasmidfinder -i "testdata/plasmidfinder_results.tsv" --tool_version "test"
python amrdb_add_results.py --method speciesfinder -i "testdata/speciesfinder.txt" --tool_version "test" --db_version "SILVA_138.1_SSUParc"
